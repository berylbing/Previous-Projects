...
public partial class StoreMen_CrystalReport_Store_4 : System.Web.UI.Page
{
    public string d = "1";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        MyConn.Open();
        string strSql = "select  * from View_5";
        SqlDataAdapter daView_1 = new SqlDataAdapter(strSql, MyConn);

        //将适配器里面的信息填充到对应的Dataset里面的Table
        daView_1.Fill(ds, "View_5");
        ReportDoc.Load(Server.MapPath("..\\StoreMen\\CrystalReport_Store_4.rpt"));
        ReportDoc.SetDatabaseLogon("sa", "lycms", @"192.168.0.236\\sqlExpress", "LYCMS");
        ReportDoc.SetDataSource(ds.Tables["View_5"]);
        MyConn.Close();
