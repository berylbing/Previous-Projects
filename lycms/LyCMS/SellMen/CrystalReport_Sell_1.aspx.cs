...
public partial class SellMen_CrystalReport_Sell_1 : System.Web.UI.Page
{
    public string d = "1";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        MyConn.Open();
        string strSql = "select  * from View_1 where staff_id='"+id+"'";
        SqlDataAdapter daView_1 = new SqlDataAdapter(strSql, MyConn);
        
        //将适配器里面的信息填充到对应的Dataset里面的Table
        daView_1.Fill(ds, "View_1");
        ReportDoc.Load(Server.MapPath("CrystalReport_Sell_1.rpt"));
        ReportDoc.SetDatabaseLogon("sa", "lycms", @"192.168.0.236\\sqlExpress", "LYCMS");
        ReportDoc.SetDataSource(ds.Tables["View_1"]);
        MyConn.Close();
