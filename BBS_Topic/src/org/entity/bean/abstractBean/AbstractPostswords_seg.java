...
public class AbstractPostswords_seg implements java.io.Serializable{
	...
	//Constructor 
	/** default constructor*/
	public AbstractPostswords_seg(){
		
	}
	public AbstractPostswords_seg(Integer pid,String wid,Double weight,Timestamp segtime,
