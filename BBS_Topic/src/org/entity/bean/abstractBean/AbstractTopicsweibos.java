 ...
 *
 */
public abstract class AbstractTopicsweibos implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractTopicsweibos() {
	}

	/** full constructor */
	public AbstractTopicsweibos(String tid, String topicId, Double similarity,
