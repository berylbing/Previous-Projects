...
//				sb.append(line_separator);
	...
	public ArrayList<Postswords_seg> segmentationTitle(String title,
			ICTCLAS50 testICTCLAS50) {
		// // TODO Auto-generated method stub
		ArrayList<Postswords_seg> al = new ArrayList<Postswords_seg>();
		try {
...
//			System.out.println(argu.getBytes("GB2312"));
			...
			for (String str : temp) {
				int guolv = 0;
				Postswords_seg stR = new Postswords_seg();
	...
	public ArrayList<Postswords_seg> segmentationContent(String content,
			ICTCLAS50 testICTCLAS50) {
		// TODO Auto-generated method stub
		ArrayList<Postswords_seg> al = new ArrayList<Postswords_seg>();
		try {
