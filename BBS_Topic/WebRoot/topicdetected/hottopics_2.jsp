    ...
    var bd = Ext.getBody(),
        ...
        updateRecord = function(rec) {
            var name, series, i, l, items, json = [{
                'Name': '2012-05-03 00:00',
                'Data': rec.get('energy0')
            }, {
            	'Name': '2012-05-03 03:00',
                'Data': rec.get('energy1')
            }, {
                'Name': '2012-05-03 06:00',
                'Data': rec.get('energy2')
            }, {
                'Name': '2012-05-03 09:00',
                'Data': rec.get('energy3')
            },{
                'Name': '2012-05-03 12:00',
                'Data': rec.get('energy4')
            },{
                'Name': '2012-05-03 15:00',
                'Data': rec.get('energy5')
            },{
                'Name': '2012-05-03 18:00',
                'Data': rec.get('energy6')
            },{
                'Name': '2012-05-03 21:00',
                'Data': rec.get('energy7')
            },{
                'Name': '2012-05-04 00:00',
                'Data': rec.get('energy8')
            }
            ];
            chs.loadData(json);
            selectItem(rec);
        ...
        var ds = Ext.create('Ext.data.Store', {
		    id:'simpsonsStore',
		    autoLoad: true,
		    fields:['title', 'energy', 'num','num2','energy7','energy8','energy6','energy5','energy4','energy3','energy0','energy1','energy2'],
             ...
             items: [gridPanel, {
                 ...
                 items: [{
                     ...
                     items: [{
                         ...
                         fieldLabel: 'RepostNum',
                         name: 'num2',
                         disabled: true
<%--                         listeners: createListeners('num')--%>
                     },{
                         fieldLabel: 'CommentNum',
                         name: 'num',
                         disabled: true
<%--                         listeners: createListeners('num')--%>
                     },{
...
<div id="doc">
 <div id="header">
   <img src="image/bt.png" alt="网络论坛热点话题发现系统" />
 </div>
 <!--header-->
 <div id="menu">
					<div class="rightbg">
