/**
 * Copyright (c) 2009，中国航天二院706所 All rights reserved.
 * 
 * @FileName: UUIDKey.java
 * @ProjectName: newhtgjk
 * @PackageName: com.ht706.test.util
 * @Author: 娄凯
 * @Time: 2010-4-29 下午03:41:31
 */
...
public class UUIDKey {
	private static UUIDKey instance = null;
