...
<script>
	...
	function c_open(path, recordId) {
		...
		var actionPath = path + "/componentFeedBack/feedback.do?method=modify&recordId=" + recordId;
...
<div class=list>
<html:form method="post" action="componentFeedBack/feedback?method=modify">
<table border="0">
	<tr>
	 <td align="center" width="30%"><b>登记号:</b></td>
	  <td>
	      <nested:text property="registryId" onblur="checkRegistryId('${recordId}')"/>
  ...
  <div id=bc align=right>
      <input type='button' value=' 提  交 ' class="input_button" onclick="c_open('${pageContext.request.contextPath}','${recordId}')">&nbsp;	     
  </div><br>
</html:form>
</div>
</body>
