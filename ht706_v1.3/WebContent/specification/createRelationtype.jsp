...
<html:form action="/specification/RelationtypeAction?method=createRelationtype" method="POST">
...
<div class=editblock >
	...
	<nested:hidden property="spid" value="${spid}"></nested:hidden>
		<tr height="35"> 
		  ...
		  <td width="75%"><nested:text  property="relationtype.relationName" /></td>
		</tr>				
		<tr height="35"> 
		  <th align="right">对应关系：</th>
		  <td><nested:text  property="relationtype.relationType" /></td>
		</tr>	
		<tr height="35"> 
		...
		<tr height="35"> 
		  ...
		  <td><nested:text  property="relationtype.description" /></td>
		</tr>									
	</table>
