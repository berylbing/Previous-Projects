  ...
  <tr>
  	<td>
	    <script type="text/javascript">  
			...
			'${list.parentNode}',//pid
			'${list.name}',//node name
			'SynonymAction.do?method=ShowSynonymAction&Idf=<bean:write name="list" property="id.facetUuid"/>&Ids=<bean:write name="list" property="id.specification.specUuid"/>&select=${select}',//url
			'${list.name}',//title
