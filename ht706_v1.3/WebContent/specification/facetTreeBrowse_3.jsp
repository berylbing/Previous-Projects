  ...
  <tr>
  	<td>
	    <script type="text/javascript">  
			...
			'${list.parentNode}',//pid
			'${list.name}',//node name
			'FacetAction.do?method=ShowFacetAction&Idf=<bean:write name="list" property="id.facetUuid"/>&Ids=<bean:write name="list" property="id.specification.specUuid"/>&select=${select}',//url
			'${list.name}',//title
