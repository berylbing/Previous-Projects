  ...
  <tr>
  	<td>
	    <script type="text/javascript">  
			...
			'${list.parentNode}',//pid
			'${list.name}',//node name
			'FacetAction.do?method=ShowFacetAction&select=view&Idf=<bean:write name="list" property="id.facetUuid"/>&Ids=<bean:write name="list" property="id.specification.specUuid"/>',//url
			'${list.name}',//title
