...
mtDropDown.dingbatOn ="../images/e1.gif"; 
mtDropDown.dingbatOff = "../images/e0.gif"; 
...
function mtDropDown(oActuator, iDirection, iLeft, iTop, iReferencePoint, parentMenuSet) {
	...
	function item_click() {
		if (!animating) {
			if (_this.items[this._index].url) 
				...
				//document.frames("mainFrame").location.href = _this.items[this._index].url;
		}
	}
	...
	function toString() {
		...
		'</div><iframe style="width:100%; height:100%; filter=\'progid:DXImageTransform.Microsoft.Alpha(opacity=0)\'"></iframe></div>';
	}
}
...
function mtDropDownItem(sText, sUrl, oParent) {
	...
	function toString(bDingbat) {
		...
		var sPaddingLeft = "padding:1px; padding-left:6px;padding-right:6px";
