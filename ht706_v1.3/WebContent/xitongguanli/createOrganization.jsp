...
<html:html>
	...
	<script type="text/javascript">
		...
		function init(){		
			document.getElementsByName("organization.sex")[0].checked = "checked";
			document.getElementsByName("organization.securityLevel")[0].checked = "checked";		
		}
	</script>
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="init()"> 
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class=title>
			...
			<html:form action="/xitongguanli/organizationAction?method=createOrganization&Id=${departmentId}" method="POST">
		<div class=editblock>
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr height="35">
					...
					<td width="75%">
						<nested:text property="organization.userName" value="${organization.name}" size="50"></nested:text>
				...
				<tr height="35">
					...
					<td width="75%">
						<nested:text property="organization.name" value="${organization.userName}" size="50"></nested:text>
						<span style="color:red;">*必填</span>
					</td>
				</tr>
				<tr height="35">
				...
				<tr height="35">
					...
					<td width="75%">
						<nested:text property="organization.address" size="50"></nested:text>
					</td>
				</tr>
				<tr height="35">
					<th align="right" width="25%">
					...
					<td width="75%">
						<nested:text property="organization.telephone" size="50"></nested:text>
					</td>
				</tr>
				<tr height="35">
					<th align="right" width="25%">
					...
					<td width="75%">
						<nested:text property="organization.email" size="50"></nested:text>
					</td>
				</tr>
				<tr height="35">
					<th align="right">
					...
					<td>
					<html:radio property="organization.securityLevel" value="公开" ></html:radio> 公开 &nbsp;&nbsp;
					<html:radio property="organization.securityLevel" value="内部"></html:radio> 内部&nbsp;&nbsp;
					<html:radio property="organization.securityLevel" value="秘密"></html:radio> 秘密&nbsp;&nbsp;
					<html:radio property="organization.securityLevel" value="机密"></html:radio>机密 &nbsp;&nbsp;
					<html:radio property="organization.securityLevel" value="绝密"></html:radio> 绝密&nbsp;&nbsp;
				...
				<tr height="35">
					...
					<td width="75%">
						<nested:text property="organization.describtion" size="50"></nested:text>
					</td>
				</tr>
