...
public final class forumIndex_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write(" \t\t\t\t<a href=\"index.do?method=viewIndex\">构件库论坛</a> &raquo; 欢迎光临，现在是 <script type=\"text/javascript\">var date= new Date(); document.write(date.toLocaleString());\t</script>\r\n");
      out.write(" \t\t\t</div>\r\n");
      out.write(" \t\t</div>\t\r\n");
      out.write(" \t</div>\r\n");
      out.write(" \t\r\n");
